...
<?php
	...
	if ( count($pageData['totalPosts'] > $session->end ) ) echo "<a href='/?url=".$bloguri.'/home/start/'.($start + getConfigOption('posts_per_page') )."/end/".($end + getConfigOption('posts_per_page') )."'>  Older Posts</a>  ";
?>
</div>
