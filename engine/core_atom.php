...
class feed {
	...
	/**
	 * Returns the requested type of output for the feed. If the
	 * type requested is not recognized, it will default to atom
	 * as that is the superior format.
	 *
	 * @param $type - the type (atom or rss) to return
	 */
