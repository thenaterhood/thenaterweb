 ...
 */
 include_once GNAT_ROOT.'/engine/lib/core_blog.php';
 include_once GNAT_ROOT.'/engine/classes/class_feed.php';
 include_once GNAT_ROOT.'/engine/classes/class_inventory.php';
