<div id="footer">
		...
		<li class='footerurl'><a href="/?id=privacy">Privacy</a></li>
		<li class='footerurl'><a href="http://validator.w3.org/check?uri=referer">Validate XHTML</a></li>
		<li class='footerurl'><a href="http://jigsaw.w3.org/css-validator/check/referer">Validate CSS</a></li>
		<li class='footerurl'>}</li>
		</ul>
		</div>
